...
const CATEGORIES_COPY =
  'В 588est в каталог попадают только изделия, которые мы и наши дизайнеры отобрали и проверили сами: качество материалов, фабрики, жизнь вещи в интерьере.';

const ZONES_COPY =
  'В 588est каталог собран по сценариям жизни — дом, сад, офис, HoReCa и тд. Выберите зону, чтобы увидеть мебель и свет под конкретный интерьер.';
