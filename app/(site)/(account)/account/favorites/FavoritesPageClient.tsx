...
import { ProjectsMarketSection } from '@/app/(site)/(public)/projects/ProjectsMarketSection';
...
import designerCardStyles from '@/app/(site)/(public)/designers/DesignersPage.module.css';
