...
import tabStyles from '../BrandsPage.module.css';
    ...
    <section className={styles.marketSection} aria-label="Товары бренда">
      <div className="padding-global">
        <div className={styles.marketSectionInner}>
          {tabs.length > 1 ? (
            <nav className={tabStyles.tabsWrapper} aria-label="Категории товаров бренда">
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={isActive ? tabStyles.tabActive : tabStyles.tab}
